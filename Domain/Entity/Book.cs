...
namespace Domain.Entity
{
    public class Book
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resource.ResourceData_En), ErrorMessageResourceName = "BookName")]
        ...
        [Required(ErrorMessageResourceType = typeof(Resource.ResourceData_En), ErrorMessageResourceName = "AuthorName")]
        [MaxLength(20, ErrorMessageResourceType = typeof(Resource.ResourceData_En), ErrorMessageResourceName = "MaxLength")]
        [MinLength(3, ErrorMessageResourceType = typeof(Resource.ResourceData_En), ErrorMessageResourceName = "MinLength")]
